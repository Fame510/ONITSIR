...
def main() -> int:
    ...
    create_args = {
        "name": REPO,
        "description": 'ONITSIR — "On It, Sir." An AI agency operating system: a routable roster of 164 specialists, a verify-gated workflow, and an autonomous phase machine.',
        "private": False,
        "auto_init": True,
